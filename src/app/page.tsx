...
export default function Home() {
  ...
  return (
    <main className="flex h-screen w-full bg-white dark:bg-gray-950 overflow-hidden transition-colors duration-200">
      ...
      <SignedOut>
        <div className="flex w-full h-full items-center justify-center bg-gray-50 dark:bg-gray-900">
          <div className="p-8 bg-white dark:bg-gray-900 dark:border dark:border-gray-800 rounded-lg shadow-md text-center">
            <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Welcome to Tars Chat</h1>
